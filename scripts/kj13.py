...
INPUT_SIZE= [(ORG_IMG_HEIGHT - (22 + 896 +  (896* 3)//4+ (896* 2)//4)) // INPUT_SCALE , (ORG_IMG_WIDTH - 24 )// INPUT_SCALE]
...
#         self.base_model = EfficientNet.from_pretrained('efficientnet-b0')
        ...
        self.xupfx3 = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)
...
# %% [code]
# inp= torch.rand([1,3, 224, 1120]).to(device)
