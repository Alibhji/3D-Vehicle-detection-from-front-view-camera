...
- In this method ve train the network to directly find 8 points for each object and then by using a post-processing method extract the object properties.
